...
(use-package lsp-json
  ...
  :custom
  (lsp-json-schemas
   `[(:fileMatch ["**/.vscode/launch.json"] :url ,(lsp--path-to-uri (expand-file-name "~/.config/my-json-schemas/launch.schema.json")))]))
#+end_src
** flycheck
#+begin_src emacs-lisp
...
(use-package dap-mode
  ...
  ;; Uses STM32Cube's VS Code extension that is wrapped in a nix flake
